...
import { OrgStore } from '../src/main/server/store'
import { createApp } from '../src/main/server/app'
import { startHttp } from '../src/main/server/http'
import { SolidGitApi } from '../src/main/client/api'
...
beforeAll(async () => {
  ...
  api = new SolidGitApi(`http://127.0.0.1:${server.port}`, 'tester')
})
